/**
 * 판단 데모 (withheld) — 실제 조정례로 4계층 파이프라인을 돌린 결과.
 *
...
import demo from "@/lib/demo/withheld";

export const metadata: Metadata = { title: "데모 — 판단 유보 | 프리케이스" };

export default function DemoPage() {
  return (
    <>
      <DemoLabel what="약관 해석이 쟁점인 실제 분쟁조정 사건으로 판단을 돌린 결과입니다." />
      <JudgmentResult
