...
export const DEFINITION_VERSION = "p0-v9";
export const TOOL_DEFINITION_VERSION = "p0-v5";
export const MANIFEST_VERSION = "finshield-p0-loan-v17";
...
export const AGENTS: readonly AgentSpec[] = Object.freeze([
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "product-institution-v9",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "fraud-channel-v9",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "sales-conduct-v9",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "regulation-dispute-v9",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "cove-v9",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "red-team-v9",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "evidence-judge-v9",
    required: true,
    tools: [],
  },
]);
...
export const POLICY_VERSIONS = Object.freeze({
  promptBundleVersion: "p0-loan-prompts-v9",
