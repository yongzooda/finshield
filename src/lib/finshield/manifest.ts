...
export const AGENTS: readonly AgentSpec[] = Object.freeze([
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "product-institution-v12",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "fraud-channel-v12",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "sales-conduct-v12",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "regulation-dispute-v12",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "cove-v12",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "red-team-v12",
    required: true,
    tools: [
  ...
  },
  {
    ...
    version: DEFINITION_VERSION, inputSchemaVersion: "in-v1", outputSchemaVersion: "out-v1", promptVersion: "evidence-judge-v12",
    required: true,
    tools: [],
  },
]);
...
export const POLICY_VERSIONS = Object.freeze({
  promptBundleVersion: "p0-loan-prompts-v12",
