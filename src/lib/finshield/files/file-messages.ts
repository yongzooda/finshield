...
const MESSAGES: Record<string, string> = {
  ...
  OCR_IMAGE_TOO_LONG: "긴 화면 캡처는 가로·세로 모두 8,000픽셀보다 작아야 글자를 읽을 수 있습니다. 두세 장으로 나눠 캡처해 올려 주세요.",
  OCR_REQUEST_FAILED: "문서 인식 서비스가 이 파일을 읽지 못했습니다. 이미지가 크거나 길면 나눠 올리고, 계속되면 내용을 텍스트로 붙여 넣어 주세요.",
  OCR_TEXT_INVALID: "한 쪽에서 읽은 글자가 없거나 너무 많습니다. 필요한 부분만 캡처해 올리거나 텍스트로 붙여 넣어 주세요.",
