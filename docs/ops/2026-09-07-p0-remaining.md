현재 추가 보안 작업: Migration 0037의 직접 RLS 세션 차단을 실제 검증했다. DB scope 변경 뒤 새 main에서 다섯 항목을 다시 측정했고 별도 PR #230에서 채택한다. main의 부분 PASS는 13/20이다. 아래 표의 기존 기준선과 최신 auth 기록을 구분한다. 세션 갱신은 별도 Draft #224에서 실제 자연 만료 시험 중이다.
