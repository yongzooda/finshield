...
- 기능 실험의 최신 전체 테스트는 489개 통과·89개 선택적 건너뜀이다. 실제 회원 PDF·PNG·10쪽 스캔 처리, 단일 Claim 결과, 재검증 NO_CHANGE, Case 삭제·반복 응답, 가입 후 점검 저장·복원과 삭제 재인증을 확인했다. 성공·실패 원본은 `evidence/development`에 함께 있다.
