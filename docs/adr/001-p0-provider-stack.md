...
| `EVID-CONSENT-01` | 동의 격리와 원본 전송 경계 | PASS | main `7ac52bd5` run `34499542659`, artifact `10161271358`, Adoption PR #313. 거절·철회 등 7경로의 전송 0건·허용 1경로 전송 1건·감사 누락 0건이다. PII 132개 중 마스킹 뒤 잔존 15개는 전송을 차단했고 정상 25개 오차단은 0건이다. 외부 Provider를 호출하지 않은 prototype 검증이다 |
