...
| `EVID-MODEL-01` | Anthropic Sonnet 5 Live Spike | PASS | FinShield 전용 Anthropic Workspace 키로 재측정한 main run `33910705253`, artifact `9951364940`; 합성 50건·100 live request·결정적 fault 20건, schema·strict tool·P95·비용 policy 합격. 무효가 된 이전 run `33783765337`·`33883439885`의 결과 파일도 이력으로 보존한다 |
