...
| `EVID-MODEL-01` | Anthropic Sonnet 5 Live Spike | STALE | run `33883439885`이 합격했으나 `.env.example`의 FinShield 재작성으로 scope digest가 바뀌어 채택이 무효; run `33783765337`과 함께 결과 파일을 보존하고 같은 harness로 재측정한다 |
