...
| `ops/rate-budget-spike.md` | `B-RATE-01` 예산·Rate·Provider 직렬화 원장 증거 harness 계약 | run `34030770858` 채택 완료 |
| `ops/consent-isolation-spike.md` | `B-CONSENT-01` 동의 격리·원본 전송 경계 증거 harness 계약 | harness 병합, 첫 main 실행 전 |
