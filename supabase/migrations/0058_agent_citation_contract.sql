...
select agent_code,'p0-v4',input_schema_version,output_schema_version,
 regexp_replace(prompt_version,'-v3$','-v4'),role,
 encode(extensions.digest(definition_hash||':claim-citation-contract-v1','sha256'),'hex')
from private.agent_definitions where version='p0-v3';
...
join private.agent_definitions a on a.id=l.agent_definition_id and a.version='p0-v3'
join private.agent_definitions n on n.agent_code=a.agent_code and n.version='p0-v4';
...
select 'finshield-p0-loan-v12',scenario,scenario_version,model_bundle,'p0-loan-prompts-v4',schema_bundle_version,evidence_policy_version,
 ...
 encode(extensions.digest(config_hash||':claim-citation-contract-v1','sha256'),'hex')
from private.execution_manifests where manifest_version='finshield-p0-loan-v11';
...
join private.execution_manifests m on m.id=a.execution_manifest_id and m.manifest_version='finshield-p0-loan-v11'
join private.agent_definitions old on old.id=a.agent_definition_id
join private.agent_definitions na on na.agent_code=old.agent_code and na.version='p0-v4'
cross join private.execution_manifests n where n.manifest_version='finshield-p0-loan-v12';
...
join private.execution_manifests m on m.id=t.execution_manifest_id and m.manifest_version='finshield-p0-loan-v11'
cross join private.execution_manifests n where n.manifest_version='finshield-p0-loan-v12';
