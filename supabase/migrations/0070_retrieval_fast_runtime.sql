...
select 'finshield-p0-loan-v21',m.scenario,m.scenario_version,
...
from private.execution_manifests m where m.manifest_version='finshield-p0-loan-v20'
...
join private.execution_manifests m on m.id=a.execution_manifest_id and m.manifest_version='finshield-p0-loan-v20'
cross join private.execution_manifests n where n.manifest_version='finshield-p0-loan-v21' on conflict do nothing;
...
join private.execution_manifests m on m.id=t.execution_manifest_id and m.manifest_version='finshield-p0-loan-v20'
cross join private.execution_manifests n where n.manifest_version='finshield-p0-loan-v21' on conflict do nothing;
