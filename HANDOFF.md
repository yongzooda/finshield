...
- Provider Implementation Gate (`N-QLT-010`): `NO-GO` — `B-MODEL-01`·`B-EMBED-01`·`B-SOURCE-02`·`B-SOURCE-03`·`B-FILE-SAFETY`·`B-RATE-01`·`B-CONSENT-01`·`B-STORAGE-01`·`B-SUPABASE-01`이 `PASS`이고 나머지 11개가 미해제다.
