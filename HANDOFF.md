...
- Provider Implementation Gate (`N-QLT-010`): `NO-GO` — `B-MODEL-01`·`B-EMBED-01`·`B-SOURCE-02`·`B-SOURCE-03`·`B-FILE-SAFETY`·`B-SUPABASE-01`·`B-RATE-01`이 `PASS`이고 나머지 13개가 미해제다. `GO` 전환에는 Claim 판정 품질 평가셋 사전등록도 필요하다.
...
- [x] `B-CONSENT-01` 동의 격리 게이트와 원본 전송 경계 증거 harness, main 전용 workflow
