...
- Migration `0023`이 들어와 `B-SUPABASE-01`·`B-RATE-01`·`B-CONSENT-01`·`B-STORAGE-01`·`B-DELETE-01`의 scope digest가 바뀌었다. 다섯을 `NOT-EVALUATED`로 되돌렸고 같은 정책으로 다시 재서 다시 채택한다.
